        ...
        <div class="row">
          <div class="tm-top-header-inner">
            <div class="tm-logo-container">
              ...
              <h1 class="tm-site-name tm-handwriting-font">Coffelicious</h1>
            </div>
...
<div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description">Hello Welcome to the Cafe <span class="gold-text">Saya Nila Ayu Setyaningrum </span> adalah Mahasiswi Jurusan Teknologi prodi Manajemen Informatika <span class="gold-text"> di POLITEKNIK NEGERI MALANG(POLINEMA)</span>. 
          Saya berasal dari Desa Bejagung, Kec Semanding, Tuban. </p>
